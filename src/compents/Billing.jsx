  ...
  return (
    <section id='product' className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        ...
        <div className='flex flex-wrap justify-between sm:mt-10 mt-6'>
            <img src={apple} alt="apple" className='w-[128px] h-[42px] object-contain mr-0 xs:mr-10 cursor-pointer' />
